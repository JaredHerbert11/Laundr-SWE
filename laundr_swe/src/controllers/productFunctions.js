...
// import LaundrProducts from "../models/productmodel";
...
// const getAllProducts = (id, data) => {
//   return data.filter((LaundrProducts) => {
//     if (LaundrProducts.id === id){
//       console.log(LaundrProducts);
//       return LaundrProducts;
//     }
//   });
// };
